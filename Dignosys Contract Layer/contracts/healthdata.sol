...
/**
* Dignosys Medical Contract System for Decentralized Reading System (DRS)
* This contact enables a doctor to communicate to a patient and create necessary services).
*
* These keys enable secure data transmission between any 2 clients.
*/

contract Dignosys is Ownable {
